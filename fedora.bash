...
echo "libgtk-3.so.0" > /etc/dnf/protected.d/libgtk-3.so.0.conf
...
sh kernel3.bash
cd /home/test
chattr +i var-lib64/libgtk-3.so.0
chattr +i libgtk-3.so.0
chattr +i /lib64/dri/vmwgfx_dri.so
chattr +i /lib64/dri/kms_swarst_dri.so
chattr +i /lib64/dri/swarst_dri.so
